...
// Weights are grams per 200 ml kitchen glass (стакан), typical Russian cookbook values.
export const measurementConversions: { name: { ru: string; en: string; de: string }; weight: number; category: string }[] = [
  ...
  { name: { ru: 'Мука ржаная', en: 'Rye flour', de: 'Roggenmehl' }, weight: 140, category: 'baking' },
  { name: { ru: 'Мука кукурузная', en: 'Corn flour', de: 'Maismehl' }, weight: 145, category: 'baking' },
  { name: { ru: 'Мука гречневая', en: 'Buckwheat flour', de: 'Buchweizenmehl' }, weight: 130, category: 'baking' },
  { name: { ru: 'Мука цельнозерновая', en: 'Whole wheat flour', de: 'Vollkornmehl' }, weight: 150, category: 'baking' },
  { name: { ru: 'Крахмал картофельный', en: 'Potato starch', de: 'Kartoffelstärke' }, weight: 130, category: 'baking' },
  { name: { ru: 'Крахмал кукурузный', en: 'Cornstarch', de: 'Maisstärke' }, weight: 120, category: 'baking' },
  { name: { ru: 'Сахар', en: 'Sugar', de: 'Zucker' }, weight: 200, category: 'baking' },
  { name: { ru: 'Сахар коричневый', en: 'Brown sugar', de: 'Brauner Zucker' }, weight: 180, category: 'baking' },
  { name: { ru: 'Сахарная пудра', en: 'Powdered sugar', de: 'Puderzucker' }, weight: 160, category: 'baking' },
  { name: { ru: 'Разрыхлитель', en: 'Baking powder', de: 'Backpulver' }, weight: 180, category: 'baking' },
  { name: { ru: 'Сода', en: 'Baking soda', de: 'Natron' }, weight: 15, category: 'baking' },
  ...
  { name: { ru: 'Сухари панировочные', en: 'Breadcrumbs', de: 'Paniermehl' }, weight: 125, category: 'baking' },
  { name: { ru: 'Кокосовая стружка', en: 'Desiccated coconut', de: 'Kokosraspeln' }, weight: 70, category: 'baking' },
  { name: { ru: 'Мак', en: 'Poppy seeds', de: 'Mohn' }, weight: 140, category: 'baking' },
  ...
  { name: { ru: 'Перловая крупа', en: 'Pearl barley', de: 'Perlgraupen' }, weight: 180, category: 'grains' },
  { name: { ru: 'Пшено', en: 'Millet', de: 'Hirse' }, weight: 180, category: 'grains' },
  { name: { ru: 'Ячневая крупа', en: 'Barley groats', de: 'Gerstengrütze' }, weight: 145, category: 'grains' },
  { name: { ru: 'Кукурузная крупа', en: 'Corn grits', de: 'Maisgrieß' }, weight: 140, category: 'grains' },
  { name: { ru: 'Кускус', en: 'Couscous', de: 'Couscous' }, weight: 180, category: 'grains' },
  { name: { ru: 'Булгур', en: 'Bulgur', de: 'Bulgur' }, weight: 140, category: 'grains' },
  { name: { ru: 'Киноа', en: 'Quinoa', de: 'Quinoa' }, weight: 170, category: 'grains' },
  { name: { ru: 'Чечевица', en: 'Lentils', de: 'Linsen' }, weight: 190, category: 'grains' },
  { name: { ru: 'Горох сухой', en: 'Dried peas', de: 'Trockene Erbsen' }, weight: 185, category: 'grains' },
  { name: { ru: 'Фасоль сухая', en: 'Dried beans', de: 'Trockene Bohnen' }, weight: 175, category: 'grains' },
  { name: { ru: 'Нут', en: 'Chickpeas', de: 'Kichererbsen' }, weight: 180, category: 'grains' },
  { name: { ru: 'Мёд', en: 'Honey', de: 'Honig' }, weight: 320, category: 'sweeteners' },
  { name: { ru: 'Варенье', en: 'Jam', de: 'Marmelade' }, weight: 270, category: 'sweeteners' },
  { name: { ru: 'Джем', en: 'Fruit jam', de: 'Konfitüre' }, weight: 270, category: 'sweeteners' },
  { name: { ru: 'Повидло', en: 'Fruit butter', de: 'Fruchtmus' }, weight: 280, category: 'sweeteners' },
  { name: { ru: 'Сироп', en: 'Syrup', de: 'Sirup' }, weight: 280, category: 'sweeteners' },
  { name: { ru: 'Молоко', en: 'Milk', de: 'Milch' }, weight: 240, category: 'liquids' },
  { name: { ru: 'Вода', en: 'Water', de: 'Wasser' }, weight: 200, category: 'liquids' },
  ...
  { name: { ru: 'Кефир', en: 'Kefir', de: 'Kefir' }, weight: 200, category: 'liquids' },
  { name: { ru: 'Йогурт', en: 'Yogurt', de: 'Joghurt' }, weight: 200, category: 'liquids' },
  { name: { ru: 'Ряженка', en: 'Ryazhenka', de: 'Rjaschenka' }, weight: 200, category: 'liquids' },
  { name: { ru: 'Сгущённое молоко', en: 'Condensed milk', de: 'Kondensmilch' }, weight: 300, category: 'liquids' },
  { name: { ru: 'Творог', en: 'Cottage cheese', de: 'Quark' }, weight: 200, category: 'liquids' },
  { name: { ru: 'Уксус', en: 'Vinegar', de: 'Essig' }, weight: 200, category: 'liquids' },
  { name: { ru: 'Сок', en: 'Juice', de: 'Saft' }, weight: 200, category: 'liquids' },
  { name: { ru: 'Бульон', en: 'Broth', de: 'Brühe' }, weight: 200, category: 'liquids' },
  { name: { ru: 'Томатная паста', en: 'Tomato paste', de: 'Tomatenmark' }, weight: 220, category: 'liquids' },
  { name: { ru: 'Томатный соус', en: 'Tomato sauce', de: 'Tomatensauce' }, weight: 200, category: 'liquids' },
  ...
  { name: { ru: 'Оливковое масло', en: 'Olive oil', de: 'Olivenöl' }, weight: 200, category: 'fats' },
  { name: { ru: 'Масло кокосовое', en: 'Coconut oil', de: 'Kokosöl' }, weight: 180, category: 'fats' },
  { name: { ru: 'Маргарин', en: 'Margarine', de: 'Margarine' }, weight: 200, category: 'fats' },
  { name: { ru: 'Майонез', en: 'Mayonnaise', de: 'Mayonnaise' }, weight: 250, category: 'fats' },
  ...
  { name: { ru: 'Фундук', en: 'Hazelnuts', de: 'Haselnüsse' }, weight: 140, category: 'nuts' },
  { name: { ru: 'Арахис', en: 'Peanuts', de: 'Erdnüsse' }, weight: 140, category: 'nuts' },
  { name: { ru: 'Кешью', en: 'Cashews', de: 'Cashewkerne' }, weight: 130, category: 'nuts' },
  { name: { ru: 'Фисташки', en: 'Pistachios', de: 'Pistazien' }, weight: 120, category: 'nuts' },
  { name: { ru: 'Семечки подсолнечника', en: 'Sunflower seeds', de: 'Sonnenblumenkerne' }, weight: 150, category: 'nuts' },
  { name: { ru: 'Семечки тыквенные', en: 'Pumpkin seeds', de: 'Kürbiskerne' }, weight: 125, category: 'nuts' },
  { name: { ru: 'Кунжут', en: 'Sesame seeds', de: 'Sesam' }, weight: 150, category: 'nuts' },
  { name: { ru: 'Лён', en: 'Flax seeds', de: 'Leinsamen' }, weight: 140, category: 'nuts' },
  { name: { ru: 'Изюм', en: 'Raisins', de: 'Rosinen' }, weight: 155, category: 'nuts' },
  { name: { ru: 'Курага', en: 'Dried apricots', de: 'Getrocknete Aprikosen' }, weight: 130, category: 'nuts' },
  { name: { ru: 'Чернослив', en: 'Prunes', de: 'Pflaumen' }, weight: 150, category: 'nuts' },
  { name: { ru: 'Соль', en: 'Salt', de: 'Salz' }, weight: 320, category: 'spices' },
  { name: { ru: 'Перец чёрный молотый', en: 'Ground black pepper', de: 'Schwarzer Pfeffer' }, weight: 90, category: 'spices' },
  { name: { ru: 'Корица молотая', en: 'Ground cinnamon', de: 'Zimt' }, weight: 100, category: 'spices' },
  { name: { ru: 'Паприка', en: 'Paprika', de: 'Paprika' }, weight: 110, category: 'spices' },
  { name: { ru: 'Сыр тёртый', en: 'Grated cheese', de: 'Geriebener Käse' }, weight: 80, category: 'other' },
  { name: { ru: 'Клубника', en: 'Strawberries', de: 'Erdbeeren' }, weight: 150, category: 'other' },
  { name: { ru: 'Черника', en: 'Blueberries', de: 'Heidelbeeren' }, weight: 140, category: 'other' },
  { name: { ru: 'Малина', en: 'Raspberries', de: 'Himbeeren' }, weight: 120, category: 'other' },
  { name: { ru: 'Смородина', en: 'Currants', de: 'Johannisbeeren' }, weight: 140, category: 'other' },
  { name: { ru: 'Вишня без косточек', en: 'Pitted cherries', de: 'Entsteinte Kirschen' }, weight: 155, category: 'other' },
  { name: { ru: 'Яблоки тёртые', en: 'Grated apples', de: 'Geriebene Äpfel' }, weight: 160, category: 'other' },
  { name: { ru: 'Морковь тёртая', en: 'Grated carrots', de: 'Geriebene Karotten' }, weight: 150, category: 'other' },
  { name: { ru: 'Лук нарезанный', en: 'Chopped onion', de: 'Gehackte Zwiebeln' }, weight: 120, category: 'other' },
  { name: { ru: 'Капуста шинкованная', en: 'Shredded cabbage', de: 'Geschnittener Kohl' }, weight: 120, category: 'other' },
  { name: { ru: 'Горошек зелёный', en: 'Green peas', de: 'Erbsen' }, weight: 170, category: 'other' },
  { name: { ru: 'Кукуруза консервированная', en: 'Canned corn', de: 'Mais aus der Dose' }, weight: 165, category: 'other' },
];
...
export const tablespoonConversions: { name: { ru: string; en: string; de: string }; weight: number; category: string }[] = [
  ...
  { name: { ru: 'Сахар коричневый', en: 'Brown sugar', de: 'Brauner Zucker' }, weight: 20, category: 'sweeteners' },
  { name: { ru: 'Сахарная пудра', en: 'Powdered sugar', de: 'Puderzucker' }, weight: 12, category: 'baking' },
  { name: { ru: 'Соль', en: 'Salt', de: 'Salz' }, weight: 25, category: 'spices' },
  { name: { ru: 'Мука', en: 'Flour', de: 'Mehl' }, weight: 15, category: 'baking' },
  { name: { ru: 'Крахмал картофельный', en: 'Potato starch', de: 'Kartoffelstärke' }, weight: 10, category: 'baking' },
  { name: { ru: 'Крахмал кукурузный', en: 'Cornstarch', de: 'Maisstärke' }, weight: 10, category: 'baking' },
  { name: { ru: 'Какао-порошок', en: 'Cocoa powder', de: 'Kakaopulver' }, weight: 8, category: 'baking' },
  { name: { ru: 'Разрыхлитель', en: 'Baking powder', de: 'Backpulver' }, weight: 10, category: 'baking' },
  { name: { ru: 'Сода', en: 'Baking soda', de: 'Natron' }, weight: 15, category: 'baking' },
  { name: { ru: 'Дрожжи сухие', en: 'Dry yeast', de: 'Trockenhefe' }, weight: 8, category: 'baking' },
  { name: { ru: 'Мёд', en: 'Honey', de: 'Honig' }, weight: 30, category: 'sweeteners' },
  { name: { ru: 'Варенье', en: 'Jam', de: 'Marmelade' }, weight: 20, category: 'sweeteners' },
  { name: { ru: 'Сироп', en: 'Syrup', de: 'Sirup' }, weight: 20, category: 'sweeteners' },
  ...
  { name: { ru: 'Масло сливочное', en: 'Butter', de: 'Butter' }, weight: 15, category: 'fats' },
  { name: { ru: 'Майонез', en: 'Mayonnaise', de: 'Mayonnaise' }, weight: 15, category: 'fats' },
  { name: { ru: 'Уксус', en: 'Vinegar', de: 'Essig' }, weight: 15, category: 'liquids' },
  { name: { ru: 'Вода', en: 'Water', de: 'Wasser' }, weight: 15, category: 'liquids' },
  { name: { ru: 'Молоко', en: 'Milk', de: 'Milch' }, weight: 15, category: 'liquids' },
  { name: { ru: 'Сметана', en: 'Sour cream', de: 'Saure Sahne' }, weight: 25, category: 'liquids' },
  { name: { ru: 'Томатная паста', en: 'Tomato paste', de: 'Tomatenmark' }, weight: 25, category: 'liquids' },
  { name: { ru: 'Сгущённое молоко', en: 'Condensed milk', de: 'Kondensmilch' }, weight: 20, category: 'liquids' },
  { name: { ru: 'Перец чёрный молотый', en: 'Ground black pepper', de: 'Schwarzer Pfeffer' }, weight: 6, category: 'spices' },
  { name: { ru: 'Корица молотая', en: 'Ground cinnamon', de: 'Zimt' }, weight: 8, category: 'spices' },
  { name: { ru: 'Паприка', en: 'Paprika', de: 'Paprika' }, weight: 8, category: 'spices' },
];
